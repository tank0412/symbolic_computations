...
public class Import {
    ...
    public Expressions checkInput(char[] text, int i) {
        ...
        if(i+1 < text.length) {
            if (text[i] == 'a' && (text[i + 1] != 's' && text[i + 1] != 'r' )) {
        ...
        if(i-1>=0 && i+2 < text.length ) {
            if ((text[i - 1] != 'v' && text[i - 1] != 'c' ) && text[i] == 's' && text[i + 1] == 'i' && text[i + 2] == 'n') { //sin
                ptr += 2;
        ...
        if(i+3 < text.length) {
            ...
            if (i - 1 >= 0) {
                if (text[i - 1] != 't' && text[i] == 'N' && text[i + 1] == 'o' && text[i + 2] == 'd' && text[i + 3] == 'e' && text[i + 4] != 'I') {//node
                    ptr += 3;
                    return Expressions.Node;
                }
            }
